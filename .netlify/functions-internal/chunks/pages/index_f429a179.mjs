...
import 'html-escaper';
import 'clsx';
import { $ as $$Navbar, a as $$NavOption, b as $$Container, c as $$Footer, d as $$Layout } from './galeria_2abb58d1.mjs';
...
const $$Article = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="items-center mb-4 justify-center w-full rounded bg-gray-50"><a${addAttribute(link, "href")} target="_blank"><img class="rounded w-full"${addAttribute(imagen, "src")} alt=""></a><div class="p-5"><a${addAttribute(link, "href")} target="_blank"><h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900">${titulo}</h5></a><p class="mb-3 font-normal text-gray-700">${descripcion}</p><a${addAttribute(link, "href")} target="_blank" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
Ver a detalle
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, {}, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "Navbar", $$Navbar, { "imagen": "https://scontent.fmid1-3.fna.fbcdn.net/v/t39.30808-6/350975952_514236867474399_3146924486109421848_n.jpg?_nc_cat=103&ccb=1-7&_nc_sid=5f2048&_nc_eui2=AeFi34o-gocXgFSLl6nWts7HKcCXB6pDowUpwJcHqkOjBTY3PY_GgStCShzt2_SLQsPt0b34_wP9Agioj0-2XfLj&_nc_ohc=0lCe9bQHQWIAX9-mE6m&_nc_ht=scontent.fmid1-3.fna&oh=00_AfDHHwzLPnoAiEBgFguo6oQom62zuFR8c_QFYCnoJfhv8A&oe=6557D9E8", "link": "https://www.facebook.com/profile.php?id=100092898635950", "nombre": "p\xE1gina oficial de conoce el sur de Veracruz" }, { "default": ($$result3) => renderTemplate`${renderComponent($$result3, "NavOption", $$NavOption, { "link": "/", "nombre": "Inicio" })}${renderComponent($$result3, "NavOption", $$NavOption, { "link": "/galeria", "nombre": "Galeria" })}` })}${renderComponent($$result2, "Container", $$Container, {}, { "default": ($$result3) => renderTemplate`${maybeRenderHead()}<main class="pt-8 pb-16 lg:pt-16 lg:pb-24 bg-white antialiased">${articulos.map((x) => renderTemplate`<div class="flex justify-between sm:px-32 mx-auto max-w-screen-xl">${renderComponent($$result3, "Article", $$Article, { "link": x.link, "imagen": x.imagen, "titulo": x.titulo, "descripcion": x.descripcion })}</div>`)}</main>` })}${renderComponent($$result2, "Footer", $$Footer, { "link": "https://www.facebook.com/profile.php?id=100092898635950", "nombre": "p\xE1gina oficial de conoce el sur de Veracruz" })}` })}`;
