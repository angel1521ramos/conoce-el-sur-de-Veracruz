...
const $$Layout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Layout;
  return renderTemplate(_a || (_a = __template(['<html lang="es"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Conoce el sur de Veracruz</title>', '</head><body class="dark:bg-gray-900">', '<script src="https://cdnjs.cloudflare.com/ajax/libs/flowbite/1.8.0/flowbite.min.js"><\/script></body></html>'])), renderHead(), renderSlot($$result, $$slots["default"]));
...
const $$Navbar = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<nav class="bg-white border-gray-200 dark:bg-gray-900"><div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4"><a${addAttribute(link, "href")} class="flex items-center space-x-3 rtl:space-x-reverse"><img${addAttribute(imagen, "src")} class="h-8" alt="Flowbite Logo"><span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">${nombre}</span></a><button data-collapse-toggle="navbar-default" type="button" class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-default" aria-expanded="false"><span class="sr-only">Open main menu</span><svg class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 17 14"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 1h15M1 7h15M1 13h15"></path></svg></button><div class="hidden w-full md:block md:w-auto" id="navbar-default"><ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">${renderSlot($$result, $$slots["default"])}</ul></div></div></nav>`;
...
const $$NavOption = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<li><a${addAttribute(link, "href")} class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">${nombre}</a></li>`;
...
const $$Footer = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Footer;
  const { nombre = "", link = "" } = Astro2.props;
  return renderTemplate`${maybeRenderHead()}<footer class="bg-white rounded-lg shadow m-4 dark:bg-gray-800"><div class="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between"><span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a${addAttribute(link, "href")} class="hover:underline">${nombre}</a>. All Rights Reserved.
...
const $$Galery = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Galery;
  return renderTemplate`${maybeRenderHead()}<div class="grid grid-cols-3 md:grid-cols-3 gap-4 mx-96">${renderSlot($$result, $$slots["default"])}</div>`;
...
const $$Galeria = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, {}, { "default": ($$result2) => renderTemplate`${renderComponent($$result2, "Navbar", $$Navbar, { "imagen": "https://scontent.fmid1-3.fna.fbcdn.net/v/t39.30808-6/350975952_514236867474399_3146924486109421848_n.jpg?_nc_cat=103&ccb=1-7&_nc_sid=5f2048&_nc_eui2=AeFi34o-gocXgFSLl6nWts7HKcCXB6pDowUpwJcHqkOjBTY3PY_GgStCShzt2_SLQsPt0b34_wP9Agioj0-2XfLj&_nc_ohc=0lCe9bQHQWIAX9-mE6m&_nc_ht=scontent.fmid1-3.fna&oh=00_AfDHHwzLPnoAiEBgFguo6oQom62zuFR8c_QFYCnoJfhv8A&oe=6557D9E8", "link": "https://www.facebook.com/profile.php?id=100092898635950", "nombre": "p\xE1gina oficial de conoce el sur de Veracruz" }, { "default": ($$result3) => renderTemplate`${renderComponent($$result3, "NavOption", $$NavOption, { "link": "/conoce-el-sur-de-Veracruz", "nombre": "Inicio" })}${renderComponent($$result3, "NavOption", $$NavOption, { "link": "/conoce-el-sur-de-Veracruz/galeria", "nombre": "Galeria" })}` })}${renderComponent($$result2, "Container", $$Container, {}, { "default": ($$result3) => renderTemplate`${renderComponent($$result3, "Galery", $$Galery, {}, { "default": ($$result4) => renderTemplate`${imagenes.map((x) => renderTemplate`${renderComponent($$result4, "GaleryImg", $$GaleryImg, { "link": x.link })}`)}` })}` })}${renderComponent($$result2, "Footer", $$Footer, { "link": "https://www.facebook.com/profile.php?id=100092898635950", "nombre": "p\xE1gina oficial de conoce el sur de Veracruz" })}` })}`;
